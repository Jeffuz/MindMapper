  ...
  return (
    <div className="flex h-screen items-center justify-center bg-teal1">
      <div className="p-5 md:p-10 rounded-md block ml-[10%] mr-[10%] bg-slate-50 drop-shadow-md">
        <h1 className="text-md md:text-2xl">Sign In</h1>
        <form action="/api/signin" method="POST" className="p-2">
          ...
          <br/>
          <button type="submit" className="w-full lg:text-lg text-sm p-1 
          rounded-sm bg-orange1 hover:bg-orange3 active:bg-teal1 transition-colors duration-500">
            Sign In
            </button>
        </form>
      </div>
